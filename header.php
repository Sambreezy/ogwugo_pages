        ...
        <div class="main-header main-menu-wapper">
            ...
            <div class="box-header-nav">
                <ul class="main-menu clone-main-menu">
                        <li class="menu-item menu-item-has-children"><a href="index2.php" class="kt-item-title" title="Home">Solutions</a>
                        </li>
                        <li class="menu-item menu-item-has-children"><a href="index2.php" class="kt-item-title" title="Shop">Membership</a>
                        </li>
                        <li class="menu-item menu-item-has-children"><a href="index2.php" class="kt-item-title" title="PAGES">Help</a>
                            <!-- <ul class="submenu">
                        ...
                        <li class="menu-item menu-item-has-children"><a href="index2.php" class="kt-item-title" title="Blog">Community</a>
                        </li>
                    </ul>
            </div>
            <div class="register">
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><img src="images/icons/nigeria-flag.png" />NGN
